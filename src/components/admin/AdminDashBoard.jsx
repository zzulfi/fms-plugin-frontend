...
import { BarChart3, Users, User, Gavel, TrendingUp, Clock, Award, Settings } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200 group cursor-pointer">
            <div className="flex items-center mb-4">
              ...
              <div className="ml-4">
                <h3 className="text-lg font-semibold text-gray-900">Auction Control</h3>
                <p className="text-sm text-gray-600">3 active auctions</p>
              </div>
            </div>
